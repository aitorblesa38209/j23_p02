...
<div class="box_specialoffers">
    ...
    <form class="contact_form" action="Busqueda.php" method="POST">
    <h1>Formulario</h1>

    <label for="nombre">Perdido / Encontrado:</label><br/><br/>
    <input type="radio" name="perdtrob" value="Perdut">Perdido<br/>
    <input type="radio" name="perdtrob" value="Trobat">Encontrado<br/><br/><br/>

	<!--Mostrar los datos de la BD de tipo de animal en el select-->
   	<label for="nombre">Tipo Animal:</label><br/><br/>
   	<input type="radio" name="tipus_animal" value="Gos">Gos<br/>
    <input type="radio" name="tipus_animal" value="Gat">Gat<br/>
    <input type="radio" name="tipus_animal" value="Ocell">Ocell<br/>
    <input type="radio" name="tipus_animal" value="Altres">Altres<br/><br/><br/>
    
      
	

		<!--Mostrar los datos de la BD de poblaciones en el select-->
        <label for="nombre">Población:</label><br/><br/>
        <select name="ciudad">
        
			<?php
                $con = mysqli_connect('localhost', 'root', 'DAW22015', 'BD_botiga_animals');   
                $sql2 = "SELECT municipi_nom FROM tbl_municipi ORDER BY municipi_nom ASC";
                $query2 = mysqli_query($con,$sql2);
                if(mysqli_num_rows($query2)>0){
                    while($nommun=mysqli_fetch_array($query2)){
                        $valor2 = utf8_encode($nommun['municipi_nom']);
